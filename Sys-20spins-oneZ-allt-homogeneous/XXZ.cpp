...
int main(){
    ...
    cout << "[";
    for(auto t : t_ls){
        double val = product_state_exp(generate_all_zero_state(), Heisenberg_Evolved_ai_dagger_ai(10, t, c_in_eta, eta_in_c, Energy));
        cout << val << ",";
    }
    cout << "]" << endl;
    ...
    cout << "[";
    for(auto t : t_ls){
        double val = product_state_exp(generate_all_one_state(), Heisenberg_Evolved_ai_dagger_ai(10, t, c_in_eta, eta_in_c, Energy));
        cout << val << ",";
    }
    cout << "]" << endl;
    ...
    cout << "[";
    for(auto t : t_ls){
        double val = product_state_exp(generate_half_half_state(), Heisenberg_Evolved_ai_dagger_ai(10, t, c_in_eta, eta_in_c, Energy));
        cout << val << ",";
    }
    cout << "]" << endl;
    ...
    cout << "[";
    for(auto t : t_ls){
        double val = product_state_exp(generate_neel_state(), Heisenberg_Evolved_ai_dagger_ai(10, t, c_in_eta, eta_in_c, Energy));
        cout << val << ",";
    }
    cout << "]" << endl;
    ...
    for(int i = 0; i < num_states; i++){
        ...
        valFile << "[";
        for(auto t : t_ls){
            double val = product_state_exp(state, Heisenberg_Evolved_ai_dagger_ai(10, t, c_in_eta, eta_in_c, Energy));
            valFile << val << ",";
        }
        valFile << "]" << endl;
    }
